...
experiences = {
    ...
    'Hyperloop Project': ["Your experience description for Hyperloop Project...", ['photos/hyp/1.png', 'photos/hyp/2.png', 'photos/hyp/3.png', 'photos/hyp/4.png']],
...
def display_selected_option(selected_option):
    if selected_option == 'Trekking':
        ...
        st.markdown('Check out this [Hyperloop Instagram Post](https://www.instagram.com/p/CY8vJVKNu0q/?hl=es-la)', unsafe_allow_html=True)
