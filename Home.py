...
if page == "Welcome!":
    ...
    st.markdown("""
    <div class="bio">
        <h4>Data Analyst | Business Analyst | Datacamp SQL Associate Certified| PowerBI and Tableau Specialist | Portfolio Management | Strategy Consultin - E-Commerce </h4>
